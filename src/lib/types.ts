...
export interface ViewActions {
	...
	update(id: string, updates: Partial<Pick<SavedView, 'name' | 'description' | 'config' | 'originalQuery'>>): Promise<void>
	delete(id: string): Promise<void>
	rename(id: string, newName: string): Promise<void>
	markModified(): void
	clearActive(): void
	nameExists(name: string, excludeId?: string): Promise<boolean>
	getStorageStats(): Promise<{ count: number; limit: number; percentFull: number }>
